...
import { Code2, Sparkles, Image, Video, BookOpen, Layers, Check } from "lucide-react";
...
const WORKSPACES: WorkspaceItem[] = [
  ...
  },
  {
    type: "study_research",
    label: "Research",
    desc: "Deep research & comparative analysis",
        ...
        {WORKSPACES.map((ws) => {
          ...
          return (
            <button
              ...
              className={cn(
                "glass-panel rounded-lg p-3.5 text-left transition-all duration-200 flex flex-col justify-between gap-2.5 relative group select-none hover:border-[#adc6ff] hover:bg-[#adc6ff]/5",
                isSelected
            ...
            >
              <div className="flex items-center justify-between w-full">
                ...
                {isSelected && (
                  <div className="w-4 h-4 rounded-full bg-[#adc6ff] text-[#002e6a] flex items-center justify-center">
              ...
              <div>
                ...
                <span className="font-mono text-[10px] text-[var(--text-muted)] leading-tight block mt-0.5">
                  {ws.desc}
                </span>
              </div>
            </button>
