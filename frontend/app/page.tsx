...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 h-16 border-b border-white/10 bg-[#07080b]/80 backdrop-blur-xl px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-indigo-500 via-purple-500 to-cyan-400 flex items-center justify-center shadow-lg shadow-indigo-500/20">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard">
            <Button
              variant="primary"
              size="sm"
              className="bg-indigo-600 hover:bg-indigo-500 text-xs shadow-md shadow-indigo-500/20"
      ...
      <main className="flex-1">
        ...
        <section className="py-24 px-6 border-t border-[var(--border-subtle)] bg-[var(--bg-secondary)] relative overflow-hidden">
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {[
                ...
                <div
                  key={step.role}
                  className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-tertiary)]/50 p-5 flex flex-col justify-between space-y-3 relative group hover:border-[var(--border-strong)] transition-colors"
                >
                  <div className="space-y-2">
                    ...
                    <span className="inline-block text-[11px] font-mono px-2 py-0.5 rounded bg-[var(--bg-secondary)] border border-[var(--border-subtle)] text-[var(--text-secondary)]">
                      {step.provider}
                    </span>
                  </div>
        ...
        <section className="py-24 px-6 bg-[var(--bg-primary)] border-t border-[var(--border-subtle)]">
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {PROVIDERS.map((prov) => (
                <div
                  key={prov.id}
                  className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-secondary)] p-6 space-y-3 hover:border-indigo-500/40 transition-colors shadow-sm"
                >
                  <div className="flex items-center justify-between">
                  ...
                  <div className="pt-2 border-t border-[var(--border-subtle)] text-[11px] font-mono text-[var(--text-muted)]">
        ...
        <section className="py-24 px-6 bg-[var(--bg-secondary)] border-t border-[var(--border-subtle)]">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3 p-6 rounded-xl bg-[var(--bg-tertiary)]/50 border border-[var(--border-subtle)]">
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)] border-t border-[var(--border-subtle)]">
          <div className="max-w-4xl mx-auto rounded-2xl bg-gradient-to-r from-indigo-900/40 via-purple-900/40 to-cyan-900/40 border border-indigo-500/30 p-8 sm:p-12 text-center space-y-6 shadow-2xl backdrop-blur-md">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/dashboard">
                <Button
                  variant="primary"
                  size="lg"
                  className="bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold shadow-lg shadow-indigo-500/30"
      ...
      {/* Footer */}
      <footer className="border-t border-[var(--border-subtle)] py-8 px-6 bg-[var(--bg-secondary)] text-center text-xs text-[var(--text-muted)] space-y-2">
